...
public class DbWebAppContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DocumentsAttached>()
            .HasMany(e => e.QuestionValues) // DocumentsAttached has many QuestionValues
            .WithOne(e => e.DocumentsAttached) // QuestionValues has one DocumentsAttached
            .HasForeignKey(e => e.DocumentsAttachedId); // DocumentsAttachedId is the foreign key property for dependent entity
        ...
        modelBuilder.Entity<CompanyType>().HasData(
                           ...
                           new CompanyType { Id = 5, Name = "Other", Description = "For any company that does not fall into the above categories." }
        );
