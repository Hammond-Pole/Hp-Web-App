...
namespace Hp_Web_App.Shared.Migrations
{
    ...
    [Migration("20231102122524_ClientTable_added")]
    partial class ClientTable_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hp_Web_App.Shared.Models.Clients_Details", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HP_Reference")
                        .IsRequired()
                        .HasMaxLength(25)
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationKeyExpires = new DateTime(2023, 11, 3, 14, 25, 24, 259, DateTimeKind.Local).AddTicks(296),
                            SentDate = new DateTime(2023, 11, 2, 14, 25, 24, 259, DateTimeKind.Local).AddTicks(300)
                        });
                });
            ...
            modelBuilder.Entity("Hp_Web_App.Shared.Models.TrainingRequestModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hp_Web_App.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CompanyId = 1,
                            Dob = new DateTime(2023, 11, 2, 14, 25, 24, 259, DateTimeKind.Local).AddTicks(151),
                            Email = "alanj@hpd.co.za",
                            IsActive = true,
                            Name = "Admin",
                            Password = "1234",
                            Phone_Num = "073 345 8900",
                            RegistrationKeyExpires = new DateTime(2023, 11, 3, 14, 25, 24, 259, DateTimeKind.Local).AddTicks(132),
                            Surname = "Jordan",
                            UserRoleId = 1
                        });
                });
