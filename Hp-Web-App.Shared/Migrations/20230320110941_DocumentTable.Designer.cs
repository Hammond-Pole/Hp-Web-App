...
namespace Hp_Web_App.Shared.Migrations
{
    ...
    [Migration("20230320110941_DocumentTable")]
            ...
            modelBuilder.Entity("Hp_Web_App.Shared.Models.CompanyDocument", b =>
                {
                    ...
                    b.Property<int?>("DocumentAttachedId")
                        .HasColumnType("int");

                    b.HasKey("CompanyId", "DocumentId");

                    b.HasIndex("DocumentAttachedId");
            ...
            modelBuilder.Entity("Hp_Web_App.Shared.Models.CompanyDocument", b =>
                {
                    ...
                    b.HasOne("Hp_Web_App.Shared.Models.DocumentsAttached", "DocumentAttached")
                        .WithMany()
                        .HasForeignKey("DocumentAttachedId")
                        .OnDelete(DeleteBehavior.NoAction);
